"""
Django settings for trickle_api project.
...
SECRET_KEY = 'django-insecure-j%5+5to+9l3w53$_g_g)lx&hp@-*czjxpa)d=bgf+s&m7j7bi*'
...
WSGI_APPLICATION = 'trickle_api.wsgi.application'
