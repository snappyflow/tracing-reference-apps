...
class Root(object):
    ...
    def dispatch(self, environ, start_response):
        ...
        try:
            ...
            begin_transaction(elasticapm, self.client, request) #add after get request
            ...
            end_transaction(elasticapm, self.client, request, response) #add before return response statement
