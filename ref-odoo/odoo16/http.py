...
class Application:
    ...
    def __call__(self, environ, start_response):
        ...
        begin_transaction(elasticapm, client, request) #add after get request
        ...
        try:
            ...
            end_transaction(elasticapm, client, request, response) #add before return response statement.
